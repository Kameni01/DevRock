...
class ShowTasks(LoginRequiredMixin, View):
    def get(self, request, proj_id):
        ...
        return render(request, 'taskmanager/my_tasks.html', context={"tasks":tasks, 'comments': comments, 'cur_project': cur_project, 'projects' : projects})
...
class ShowTask(LoginRequiredMixin, View):
    def get(self, request, id, proj_id):
        ...
        projects = Projects.objects.all()
        form = CommentForm()
        return render(request, 'taskmanager/task.html', context={"tasks":tasks, "form": form, 'comments': comments, "cur_task": task, 'cur_project': cur_project, 'projects': projects})
